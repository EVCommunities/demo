...
// NOTE: added to help modify string values to booleans
...
module.exports = {
  mongodb: {
    ...
    connectionOptions: {
      ...
      // NOTE: modified to force the variable to be given as a boolean
      ssl: getBoolean(process.env.ME_CONFIG_MONGODB_SSL, false),

      // sslValidate: validate mongod server certificate against CA
      // NOTE: modified to force the variable to be given as a boolean
      sslValidate: getBoolean(process.env.ME_CONFIG_MONGODB_SSLVALIDATE, false),

      // sslCA: array of valid CA certificates
      // NOTE: modified to force the CA file contents to be given as a string
      sslCA: sslCAFromEnv ? sslCAFromEnv.toString() : "",
